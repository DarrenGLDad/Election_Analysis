...
file_to_save = os.path.join("analysis", "/Users/darrenlemyacrawford/Desktop/Class folder/Election_Analysis/Analysis/election_analysis.txt")
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        total_votes += 1
    # Print/Get the candidate name from each row.
